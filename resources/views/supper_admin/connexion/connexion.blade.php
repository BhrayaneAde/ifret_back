            ...
            <div>
               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <h6 class="mb-4">Veuillez saisir vos informations d'authentification</h6>
                     <form id="formAuthentication" class="mb-3" action="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/html/vertical-menu-template/index.html" method="GET">
                        <div class="mb-3">
